...
(function () {
  ...
  each('[data-site="social"]', function (el) {
    ...
    names.forEach(function (name) {
      ...
      a.appendChild(make("span", "sr-only", " (opens in a new tab)"));
      el.appendChild(a);
    });
  });
  ...
  each('[data-site="credits"]', function (el) {
    ...
    el.appendChild(document.createTextNode("Photo credits: "));
  ...
  each('[data-site="map-embed"]', function (el) {
    ...
    frame.title = "Map showing where to find " + (S.name || "the restaurant");
    frame.loading = "lazy";
